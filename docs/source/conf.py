...
# make my life easier, configure the autoapi with specific options for things
# that I care about ... aka hide 'private-members' - inheriting classes should
# not have to handle or interfere with private variables hide
# 'imported-members' - after all i import the submodules into the base
# namespace - don't need it to show twice
autoapi_options = [
    'members',
    'undoc-members',
    'show-inheritance',
...
# comment out when all documentation has documented parameters ... sometimes
# causes duplicates, but that may be a RST problem... always put links at the
# END of the docstring instead of in the middle
...
inheritance_node_attrs = dict(
    shape='box', fontsize=14, height=0.75, color='dodgerblue1',
    style='rounded',
)
