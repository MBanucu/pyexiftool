...
class HelperInitializationTest(unittest.TestCase):
    def test_initialization(self):
        ...
        this is to test that the constructor passes the right values to the base class
        (ensure that the class inheritence working as expected even if underlying base class
        parameters change)
        """
