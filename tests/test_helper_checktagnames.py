...
class TagNameWriteTest(unittest.TestCase):
    ...
    def test_tag_name_hyphen(self):
        ...
        this example also demonstrates how what you ask for as a tag isn't what you get
        back sometimes... the tag comes back in the case that's defined inside exiftool
        """
