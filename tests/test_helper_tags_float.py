...
class TestHelperFloatTags(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_data_str = [
                ...
                [{"Comment": Decimal('935733.817019799357333475932629142801644788893573383506621454627967')},
    ...
    def test_baseline_exiftool_behavior(self):
        ...
        test_data = [
                ...
                [{"Comment": Decimal('935733.817019799357333475932629142801644788893573383506621454627967')},
                 '935733.817019799357333475932629142801644788893573383506621454627967'],
                # exiftool removes a space (might be an exiftool bug)  TODO more investigation
                # on this specific case, and report bug if it is
                [{"Comment": "   1      "}, "  1      "],
